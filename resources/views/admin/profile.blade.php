...
<head>
    ...
    <title>Admin Profile | Resolve</title>
            ...
            <div class="dashboard-content">
                ...
                <div class="profile-card" style="background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
                    <div class="profile-header" style="text-align: center; margin-bottom: 2rem;">
                        <div class="avatar" style="width: 100px; height: 100px; background: #4338ca; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 3rem; margin: 0 auto 1rem;">
                            {{ substr($user->name, 0, 1) }}
                        </div>
                        <h1 style="margin: 0; color: #111827;">{{ $user->name }}</h1>
                        <p style="color: #6b7280; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; margin-top: 0.5rem;">{{ $user->role }}</p>
                    </div>

                    <div class="info-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem;">
                        <div class="info-item">
                            <label style="display: block; font-size: 0.75rem; font-weight: bold; color: #6b7280; margin-bottom: 0.5rem;">USER ID</label>
                        ...
                        <div class="info-item">
                            <label style="display: block; font-size: 0.75rem; font-weight: bold; color: #6b7280; margin-bottom: 0.5rem;">ACCOUNT STATUS</label>
                            <p style="margin: 0; font-size: 1rem; color: #059669; font-weight: 600;">Active</p>
                        </div>
                    </div>
                </div>
            </div>
