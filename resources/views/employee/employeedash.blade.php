    ...
    <main class="main-content">
      ...
      <header class="top-header">
        ...
        <div style="display: flex; align-items: center; margin-left: 1rem;">
          <h2 style="font-size: 1.25rem; font-weight: 700; margin: 0;">Welcome, Employee</h2>
        </div>
      ...
      <div class="dashboard-content" style="margin-top: 0;">
        <div class="activity-card mt-card" style="margin-top: 0;">
          <div class="activity-header">
            ...
            <a href="{{ route('employee.tickets') }}" class="view-all">View All Updates</a>
          </div>
                ...
                <p class="activity-text">
                  ...
                  @elseif($activity->action == 'message_sent')
                    @if($activity->user_id === Auth::id())
                      You sent a message
                    @else
                      {{ $activity->user->name ?? 'Technician' }} sent a message
                    @endif
                  ...
                  @if($activity->ticket)
                  <a href="{{ route('employee.tickets.details', $activity->ticket->id) }}" class="text-blue" style="text-decoration: none;">
